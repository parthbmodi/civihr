...
class CRM_Hrjobcontract_Upgrader extends CRM_Hrjobcontract_Upgrader_Base {
  ...
  public function upgrade_1024() {
    $this->up1024_removeUnneededPayScales();
    $this->up1024_removeUnneededHourLocations();
   ...
   */
  private function up1024_removeUnneededPayScales() {
   ...
   */
  private function up1024_removeUnneededHourLocations() {
   ...
   */
   private function up1024_sortContractTypes() {
